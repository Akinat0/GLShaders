#ifndef TransformationExample_h
#define TransformationExample_h
#endif /* TransformationExample_h */
...
class TransformationExample{
    ...
    int Start() {
        ...
        while( !glfwWindowShouldClose(window)){
            ...
            //Use it if u want translate the object at the screen
            //transform = glm::translate(transform, glm::vec3(0.5f, 0.5f, 0.0f));
            
                                                //value                 //axis
            transform = glm::rotate(transform, (GLfloat)glfwGetTime(), glm::vec3(0.0f, 1.0f, 0.0f));
